...
namespace hello_app{
    public class Program{
        /*
            ...
            In ASP.NET, When receive request => all request go through codes and handle return respond corresponding response. 
            (the component that request go through called ((pipeline) => It is a string Middleware)
        */
